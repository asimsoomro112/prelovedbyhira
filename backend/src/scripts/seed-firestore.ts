...
async function seed() {
	...
	try {
		...
		const products = [
			{
				...
				condition: "Pristine",
				description:
					"Exquisite red velvet lehnga with intricate hand-embroidery. Worn once for 4 hours. Authenticity card included.",
				images: [
			...
			},
			{
				...
				condition: "Excellent",
				description:
					"Hand-worked teal raw silk suit with organza dupatta. Perfect for shadi guest wear.",
				images: [
			...
			},
			{
				...
				condition: "Like New",
				description:
					"Heavy Kundan choker with semi-precious stones and pearls. Gold plated.",
				images: [
		...
		console.log(
			"✨ Seeding complete! You can now login as seller@revault.com (Use the Register page to create this user in Auth first if testing Login).",
		);
	} catch (error) {
