		...
		<div className="min-h-[80vh] flex items-center justify-center p-4">
			...
			>
				...
				<AnimatePresence mode="wait">
					...
					{step === 4 && (
						...
						>
							...
							<Link
								href="/login"
								className="block w-full bg-gold-400 text-white py-4 rounded-pill font-bold shadow-gold"
							>
								Back to Login
							</Link>
						</motion.div>
				...
				{step < 4 && (
					<Link
						href="/login"
						className="flex items-center justify-center gap-2 text-sm text-gray-500 hover:text-gold-400 transition-colors"
					>
