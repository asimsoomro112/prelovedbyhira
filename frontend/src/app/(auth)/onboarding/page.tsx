	...
	return (
		<div className="min-h-screen bg-cream-50 dark:bg-dark-900 flex items-center justify-center p-4">
			<div className="w-full max-w-xl">
				...
				<motion.div className="bg-white dark:bg-dark-800 rounded-[40px] shadow-card border border-gold-400/10 overflow-hidden relative min-h-[400px]">
						...
						{step === 1 && (
							...
							>
								...
								<div className="grid grid-cols-2 gap-4">
									...
									>
										{preferences.interests.includes("Clothes") && (
									...
									>
										{preferences.interests.includes("Accessories") && (
											<div className="absolute top-3 right-3 bg-gold-400 text-white rounded-full p-1">
												<CheckCircle2 className="w-4 h-4" />
											</div>
										)}
						...
						{step === 2 && (
							...
							>
								<div className="text-center space-y-2">
									...
									<p className="text-gray-500 text-sm">
										Select sizes to find items that fit perfectly.
									</p>
								</div>
						...
						{step === 3 && (
							...
							>
								<div className="text-center space-y-2">
									...
									<p className="text-gray-500 text-sm">
										We'll show you local sellers first for faster delivery.
									</p>
								</div>
