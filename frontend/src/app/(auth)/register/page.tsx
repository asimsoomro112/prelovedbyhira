      ...
      >
        <div className="p-8 lg:p-12 space-y-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input {...register("name")} placeholder="Zoya Ahmed" className="w-full bg-cream-50 dark:bg-dark-800 border border-gold-400/20 rounded-2xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-gold-400/50 transition-all text-sm" />
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input {...register("email")} type="email" placeholder="user@revault.pk" className="w-full bg-cream-50 dark:bg-dark-800 border border-gold-400/20 rounded-2xl pl-12 pr-4 py-3 outline-none focus:ring-2 focus:ring-gold-400/50 transition-all text-sm" />
              </div>
          ...
          <div className="relative">
             ...
             <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span className="bg-white dark:bg-dark-900 px-4 text-gray-400">Or Instant Membership</span></div>
          </div>
          ...
          >
            <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 8.82-4.53z"/>
            </svg>
            Sign up with Google
          </button>
