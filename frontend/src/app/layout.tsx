							...
							"@graph": [
								{
									...
									foundingDate: "2026",
									sameAs: ["https://instagram.com/revaborhira"],
									contactPoint: {
										"@type": "ContactPoint",
				...
				<Providers>
					<div className="flex flex-col min-h-screen min-h-[100dvh] relative overflow-x-hidden">
						...
						<div className="fixed inset-0 pointer-events-none z-0">
							...
							<div
								className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-gold-400/10 md:bg-gold-400/5 blur-[80px] md:blur-[120px] rounded-full animate-glow opacity-50 md:opacity-100"
