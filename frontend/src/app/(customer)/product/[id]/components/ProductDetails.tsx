...
export function ProductDetails({ product }: ProductDetailsProps) {
	const [activeTab, setActiveTab] = useState<"desc" | "specs" | "shipping">(
		"desc",
	);
					...
					>
						<div className="prose prose-gold dark:prose-invert max-w-none">
							<p className="text-lg lg:text-xl text-dark-800 dark:text-cream-100 font-medium leading-relaxed italic border-l-4 border-gold-400 pl-6 py-1">
								{product.description ||
									"No detailed description provided for this luxury piece."}
							</p>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
							<div className="p-6 bg-gold-400/5 rounded-[32px] border border-gold-400/10">
								<div className="flex items-center gap-3 mb-4">
									...
									<h4 className="text-sm font-black uppercase tracking-widest text-dark-900 dark:text-cream-50">
										Vault Authenticity
									</h4>
								</div>
								<p className="text-xs text-gray-500 leading-relaxed font-medium">
									This {product.brand} piece has been meticulously audited via
									our Neural-Verification protocol. Every stitch, fabric weave,
									and serial tag has been cross-referenced with luxury archives
									to ensure a 100% authentic resale experience.
								</p>
							</div>
							...
							<div className="p-6 bg-emerald-500/5 rounded-[32px] border border-emerald-500/10">
								...
								<p className="text-xs text-gray-500 leading-relaxed font-medium">
									By choosing this preloved item, you've saved approx.{" "}
									...
									emissions compared to buying new. Luxury that respects the
									planet.
								</p>
							</div>
						</div>
				...
				{activeTab === "specs" && (
					...
					>
						{[
							...
							{
								label: "Size",
								val: product.size || "Standard",
								icon: <Ruler size={14} />,
							},
							{
								label: "Color",
								val: product.color || "Original",
								icon: (
									<div
							...
							{
								label: "Material",
								val: product.material || "Premium Silk/Cotton",
								icon: <Zap size={14} />,
							},
							...
							<div
								key={i}
								className="p-4 bg-white dark:bg-dark-900 rounded-2xl border border-gold-400/10 shadow-sm flex flex-col gap-2"
							>
					...
					>
						<div className="max-w-2xl space-y-6">
							<div className="flex items-start gap-4">
								...
								<div>
									<h4 className="text-lg font-bold text-dark-900 dark:text-cream-50">
										Insured Luxury Shipping
									</h4>
									<p className="text-sm text-gray-500 leading-relaxed mt-1">
										Every order is handled via our premium logistics network.
										Karachi/Lahore/Islamabad: 2-3 working days. Other cities:
										4-5 working days. Fully tracked and insured until it reaches
										your doorstep.
									</p>
								</div>
							</div>
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-sm text-gray-500 leading-relaxed mt-1">
										Payment is only released to the seller after you confirm
										delivery. Our 7-day 'Secure Dispute' protocol protects you
										against items not as described.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="flex items-center gap-4">
						...
						<div>
							...
							<p className="text-sm text-gray-500 mt-1">
								Have questions about this item or need to report an issue?
							</p>
						</div>
					</div>
					<button
...
function Sparkles({ size }: { size: number }) {
	return <Zap size={size} className="text-gold-400" />;
}
