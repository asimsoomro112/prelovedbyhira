			...
			<section className="relative min-h-[85vh] flex items-center bg-dark-950 px-6 py-20 lg:py-0">
				...
				<div className="max-w-screen-xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
					<div className="space-y-8">
						...
						>
							Buy & Sell preloved fashion — Bags, Dresses, Shoes & More. Trusted
							by thousands across Pakistan.
						</motion.p>
						...
						>
							<Link
								href="/products"
								className="px-10 py-4 bg-gradient-to-r from-gold-400 to-gold-600 text-white rounded-pill font-bold shadow-gold hover:scale-105 transition-all flex items-center gap-2 group"
							>
								Shop Now{" "}
							...
							<Link
								...
								className="px-10 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-pill font-bold hover:bg-white/20 transition-all"
							>
								Sell Your Wardrobe
							</Link>
						</motion.div>
						...
						>
							<div className="flex items-center gap-2">
								<ShieldCheck className="text-gold-400 w-5 h-5" /> Secure Escrow
							</div>
							<div className="flex items-center gap-2">
								<Truck className="text-gold-400 w-5 h-5" /> Verified Sellers
							</div>
							<div className="flex items-center gap-2">
								<MessageCircle className="text-gold-400 w-5 h-5" /> 24/7 Support
							</div>
						</motion.div>
					</div>
					...
					<div className="hidden lg:flex justify-center relative h-[600px]">
						...
						>
							<div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-6 flex flex-col justify-end">
								...
								<p className="text-gold-400 text-xs uppercase">
			...
			<section className="py-24 px-6 max-w-screen-xl mx-auto">
				<div className="flex items-end justify-between mb-12">
					<div className="space-y-4">
						<h2 className="text-4xl font-display text-dark-900 dark:text-cream-50">
							Shop by Category
						</h2>
						<p className="text-gray-500">
							Explore curated collections from top wardrobes
						</p>
					</div>
					<Link
						href="/products"
			...
			<section className="py-24 bg-cream-100 dark:bg-dark-900 px-6">
				<div className="max-w-screen-xl mx-auto text-center space-y-16">
					<div className="space-y-4">
						...
						<p className="text-gray-500">
							Buying and selling fashion has never been this easy
						</p>
					</div>
...
function CategoryCard({ title, emoji, count, color, className = "" }: any) {
	return (
		...
		>
			<div className="absolute top-8 left-8 text-6xl group-hover:scale-125 transition-transform duration-500">
				{emoji}
			</div>
...
function StepCard({ num, icon, title, desc }: any) {
	return (
		...
		>
			<span className="absolute top-6 right-8 text-6xl font-display text-gold-400/10 select-none">
				{num}
			</span>
