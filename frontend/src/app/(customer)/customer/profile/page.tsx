    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="relative mb-12">
        ...
        <div className="pt-24 px-8 flex flex-col md:flex-row items-end gap-6">
           ...
           <Link href="/customer/settings" className="mb-2 px-6 py-3 bg-white dark:bg-dark-800 rounded-pill border border-gold-400/20 text-sm font-bold shadow-soft hover:shadow-card transition-all">
             Account Settings
           </Link>
        </div>
      </div>
        ...
        <div className="space-y-4">
           ...
           <div className="p-6 bg-emerald-500/5 rounded-[40px] border border-emerald-500/20">
              <p className="text-xs text-emerald-700 dark:text-emerald-400 leading-relaxed">
                 <span className="font-bold">Member Since:</span> {user.createdAt ? new Date(user.createdAt).getFullYear() : new Date().getFullYear()} <br />
