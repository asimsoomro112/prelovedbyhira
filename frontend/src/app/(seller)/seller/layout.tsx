...
function VerificationBadge({ status }: { status: string }) {
	...
	return (
		<div
			className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest ${cfg.color} ${cfg.bg}`}
		>
			{cfg.icon}
			{cfg.label}
		</div>
		...
		<div className="flex min-h-screen bg-cream-50 dark:bg-[#080808] text-dark-900 dark:text-white selection:bg-gold-400 selection:text-white">
			...
			<aside className="hidden lg:flex w-72 flex-col fixed inset-y-0 z-[60] overflow-hidden bg-white dark:bg-[#0a0a0a] border-r border-gold-400/10">
				...
				<div
					...
					style={{
						background:
							"radial-gradient(ellipse 80% 100% at 50% 0%, rgba(212,175,55,0.25) 0%, transparent 70%)",
						filter: "blur(20px)",
					}}
				/>
				<SidebarInner
			...
			<main className="flex-1 lg:ml-72 flex flex-col min-h-screen relative">
				...
				<div
					aria-hidden
					className="pointer-events-none fixed top-[-15%] right-[-8%] w-[600px] h-[600px] bg-gold-400/4 blur-[130px] rounded-full hidden lg:block"
				/>
				<div
					aria-hidden
					className="pointer-events-none fixed bottom-[-10%] left-[10%] w-[400px] h-[400px] bg-gold-400/3 blur-[100px] rounded-full hidden lg:block"
				/>
				...
				>
					...
					<div className="flex items-center gap-4">
						...
						<div className="hidden lg:flex items-center gap-2">
							...
							<span className="text-sm font-black text-dark-900 dark:text-white capitalize">
								{currentPage}
							</span>
						</div>
					</div>
		...
		<div className="flex flex-col h-full relative">
			...
			<div className="flex-shrink-0 m-4 mt-2">
				...
				<div
					...
					style={{
						background:
							"radial-gradient(ellipse 70% 80% at 50% 100%, rgba(212,175,55,0.2) 0%, transparent 70%)",
						filter: "blur(16px)",
					}}
				/>
				...
				<div className="relative glass-ultra crystal-border rounded-[28px] p-5 space-y-4 overflow-hidden">
					...
					<div
						...
						style={{
							background:
								"linear-gradient(90deg, transparent, rgba(212,175,55,0.45) 40%, rgba(255,255,255,0.25) 60%, transparent)",
						}}
					/>
					...
					<div className="flex items-center gap-3">
						...
						<div className="min-w-0">
							<p className="text-xs font-black text-dark-900 dark:text-cream-50 truncate">
								{user?.name}
							</p>
