						...
						>
							...
							<div className="p-4 bg-cream-50 dark:bg-dark-950 text-center">
								<Link
									...
									className="text-xs font-bold text-gray-500 hover:text-gold-400 transition-colors"
								>
									View All Activity
								</Link>
							</div>
	...
	return (
		...
		>
			<div className="flex gap-4">
				<div
					className={`w-10 h-10 rounded-xl bg-white dark:bg-dark-800 shadow-soft flex items-center justify-center shrink-0`}
				>
					<Icon className="w-5 h-5 text-gold-400" />
				</div>
				<div className="space-y-1">
					<p className="text-sm font-bold text-dark-900 dark:text-cream-50 leading-tight">
						{notification.title}
					</p>
